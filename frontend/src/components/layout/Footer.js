        ...
        <div className="bg-[#0D9488]">
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-16 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              >
                Precisa de coleta e destinacao de residuos industriais?
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm leading-relaxed">
                Coleta, transporte e destinacao de residuos industriais e efluentes com conformidade ambiental. Atendimento em todo o Brasil.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/gestao-de-residuos" className="text-sm text-slate-400 hover:text-[#2DD4BF] transition-colors">Gestao de Residuos Industriais</Link></li>
                <li><Link to="/transporte-de-residuos-classe-i" className="text-sm text-slate-400 hover:text-[#2DD4BF] transition-colors">Transporte de Residuos Classe I</Link></li>
                <li><Link to="/documentacao-ambiental" className="text-sm text-slate-400 hover:text-[#2DD4BF] transition-colors">Documentacao Ambiental</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-sm text-slate-400">Atendimento em todo o Brasil</span>
                </li>
                <li className="flex items-start gap-3">
        ...
        <div className="border-t border-slate-800">
          <div className="max-w-7xl mx-auto px-6 md:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-slate-500">
              &copy; {new Date().getFullYear()} Usina Recicla. Todos os direitos reservados.
            </p>
            <p className="text-xs text-slate-500">
              Gestao Integrada de Residuos Industriais e Efluentes - Atendimento em todo o Brasil
            </p>
          </div>
        </div>
      </div>
